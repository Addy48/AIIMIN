...
export default function TeamSelector({
  ...
  return (
    <motion.div
      ...
      <div
        className="w-full max-w-xs rounded-2xl border border-zinc-200/80 bg-white p-6 shadow-[0_1px_4px_rgba(0,0,0,0.06)] dark:border-white/8 dark:bg-zinc-900/60">
        <fieldset>
          <legend
            className="mb-6 w-full font-medium text-xs text-zinc-400 uppercase tracking-widest dark:text-zinc-500">
            {label}
          </legend>
