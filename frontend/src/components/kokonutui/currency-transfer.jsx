                  ...
                  {isCompleted ? (
                    ...
                    <motion.div
                      ...
                      <div className="relative z-10">
                        ...
                        <div
                          className="relative z-10 rounded-full bg-white p-5 shadow-[0_0_15px_rgba(16,185,129,0.1)] dark:bg-zinc-900">
            ...
            <motion.div
                            ...
                            <div className="flex flex-col items-start">
                              <AnimatePresence mode="wait">
                                <motion.span
                                  ...
                                  className={cn("font-medium text-zinc-900 tracking-tight dark:text-zinc-100")}
                                  exit={{
                                    opacity: isCompleted ? 1 : 0.5,
                                  }}
                                  initial={{
              ...
              <motion.div
                ...
                <Tooltip>
                  <TooltipTrigger>
                    <InfoIcon
                      className="h-3 w-3 text-zinc-400 transition-colors hover:text-zinc-600 dark:hover:text-zinc-300" />
                  </TooltipTrigger>
                  <TooltipContent>
                    <p className="text-xs">
                      {isCompleted
