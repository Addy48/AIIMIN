  ...
  return (
    <>
      <section className="report-hero report-hero--daily">
        <div><div className="report-eyebrow">{TIER_COPY.explore.eyebrow}</div><h2>{TIER_COPY.explore.title}</h2><p>{TIER_COPY.explore.subtitle}</p></div>
...
function CoreReview({ report, timeline }) {
  ...
  return (
    <>
      <section className="report-hero report-hero--core"><div><div className="report-eyebrow">{TIER_COPY.core.eyebrow}</div><h2>{TIER_COPY.core.title}</h2><p>{TIER_COPY.core.subtitle}</p></div><ScoreMark value={week.currentAvg} confidence={report?.scoreConfidence} uncertainty={report?.uncertaintyBand} /></section>
