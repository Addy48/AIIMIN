...
const TIER_SOUL = {
  explore: {
    ...
    unlocks: ['Daily log', 'Basic streaks', '30-day history', 'Help centre'],
  ...
  core: {
    ...
    unlocks: ['Habits & money', 'Focus timer', 'Weekly patterns', 'Goals'],
  ...
  pro: {
    color: '#ff6b35',
    eyebrow: "You're on",
    tagline: 'Deeper patterns, reports, and Family vault — now open.',
    unlocks: ['Correlation insights', 'Habit recovery', 'Monthly reports', 'Family vault'],
    whisper: 'Updating your plan',
    cta: 'Continue on Pro',
  },
  elite: {
    color: '#fbbf24',
    eyebrow: "You're on",
    tagline: 'Full access — unlimited AI depth, priority queue, early modules.',
    unlocks: ['Unlimited AI depth', 'Sports briefing', 'Priority support', 'Early access'],
    whisper: 'Updating your plan',
