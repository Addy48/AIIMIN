...
const ANNOUNCEMENTS = [
  ...
  { badge: 'SECURITY', text: 'StrongBox TEE hardware keystore · Zero ad tracking', icon: ShieldCheck, accent: '#749dc4' },
    ...
    <div className="waitlist-announcement-bar" role="region" aria-label="Announcements">
      <div className="waitlist-announcement-bar-inner">
        {items.map((item, idx) => {
          ...
          return (
            <div key={idx} className="waitlist-announcement-item" aria-hidden={isDuplicate ? 'true' : undefined}>
