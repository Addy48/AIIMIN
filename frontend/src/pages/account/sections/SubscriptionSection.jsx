...
const STATIC_TIERS = [
  {
    ...
    features: [
      ...
      'Daily Signal · 7-day pulse on Reports',
    ],
  },
  {
    id: 'core',
    ...
    features: [
      ...
      'Weekly Loop Review · seven-day comparison on Reports',
      '10 AI calls per day',
    ],
  },
  {
    ...
    features: [
      'Everything in Core',
      'Performance Dossier · 14/30/60/90/YTD windows',
      'Correlation Intelligence with evidence drawer',
      'Life OS Review PDF · 6 standard PDFs / month',
      'Standard PDFs use a separate monthly pool',
  ...
  },
  {
    ...
    features: [
      'Everything in Pro',
      'Intelligence Room · selectable patterns, alternatives, and tests',
