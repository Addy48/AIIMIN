...
public class SignInRequestJsonAdapter(
  moshi: Moshi,
) : JsonAdapter<SignInRequest>() {
  ...
  override fun toString(): String = buildString(35) {
      append("GeneratedJsonAdapter(").append("SignInRequest").append(')') }

  override fun fromJson(reader: JsonReader): SignInRequest {
  ...
  override fun toJson(writer: JsonWriter, value_: SignInRequest?) {
    if (value_ == null) {
