...
public class SignInUsernameRequestJsonAdapter(
  moshi: Moshi,
) : JsonAdapter<SignInUsernameRequest>() {
  ...
  override fun toString(): String = buildString(43) {
      append("GeneratedJsonAdapter(").append("SignInUsernameRequest").append(')') }

  override fun fromJson(reader: JsonReader): SignInUsernameRequest {
  ...
  override fun toJson(writer: JsonWriter, value_: SignInUsernameRequest?) {
    if (value_ == null) {
