...
| **Prototype** | `frontend/prototypes/personal-os/v6-android-life-os.html` (+ Downloads copy) — dual device, L/D, full flows. |
...
The interactive reference implementation of §4, §5, §7, §25 and §26 lives at `frontend/prototypes/personal-os/aiimin-android-v2.html` — a single self-contained file rendering the Android app in iPhone 16 Pro and Galaxy S26 device frames, with light/dark toggle, full onboarding, the main surfaces, and the settings tree. It is the visual contract for implementation; when it and this document disagree, this document wins.
