...
- **Project:** `yubxgftugxbwtywyhcsv`
- **URL:** https://yubxgftugxbwtywyhcsv.supabase.co
- **Schema:** `backend/supabase_init.sql`

## Issues

- `users.clerk_id` missing
- RLS gaps — [[05-Security/RLS-Audit]]
- Missing tables per [[05-Security/Production-Gap-Report]]

## Future

May migrate to AWS RDS — [[08-Migration/AWS-Cognito-Exploration]]
