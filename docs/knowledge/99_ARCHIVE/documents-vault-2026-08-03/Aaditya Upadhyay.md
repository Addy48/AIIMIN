...
- Builder of [[01-Architecture/Overview|AIIMIN]]
- Placement target: July 26 (referenced in Overview countdown UI)

## Project locations

- Code: `~/Desktop/DASHBOARD PROJECT`
- Backlog: `~/Desktop/AIIMIN_MASTER_BACKLOG.md`
- Vault: `~/Documents/AIIMIN VAULT`
- Docs: `~/Desktop/AIIMIN/`
