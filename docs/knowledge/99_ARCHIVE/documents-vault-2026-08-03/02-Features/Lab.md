...
Full lab page: cognitive benchmark, typing, flashcards (FSRS), aptitude, vocal mastery, STAR method, etc.

## Commits

- `d8fc0cc8` — lab UI/UX, speaking logger rename, Gemini models

## Gating

Cognitive benchmark — Core tier
