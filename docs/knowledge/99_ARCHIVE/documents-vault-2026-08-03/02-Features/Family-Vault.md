...
Members, documents, insurance, health, vehicles, finance, reminders, emergency

## Gating

Pro tier via `FeatureGate`

## AWS debt

Pre-signed S3 + CloudFront not implemented (backlog A4)

## Open

- Save Member E2E with real auth (I2)
- Document expiry email cron (exists; verify prod)
