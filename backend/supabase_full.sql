...
CREATE TABLE IF NOT EXISTS public.users (
    ...
    quarterly_review_anchor DATE DEFAULT '2026-01-01',
    lab_onboarded_at TIMESTAMPTZ,
...
CREATE TABLE IF NOT EXISTS public.daily_logs (
    ...
    -- Reset counter (RC tracker — consolidated from legacy masturbation_* columns)
    ...
    learning_topic     TEXT,
    journal_entry      TEXT,
    -- Mood: 1-5 unified scale (consolidated from legacy 1-10)
...
-- Must drop TABLE first if it exists from the legacy schema, then drop VIEW for idempotency
...
-- savings_goals: REMOVED (consolidated into financial_goals — C-1)
-- Use financial_goals instead. See migration 020_schema_cleanup.sql.
...
ALTER TABLE public.daily_logs ADD COLUMN IF NOT EXISTS mood               SMALLINT CHECK (mood BETWEEN 1 AND 5);
...
-- savings_goals upgrade guard removed (table dropped — C-1)
...
-- ============================================================
-- SECTION 17: THE LAB (Practice / Intel / Audit)
-- ============================================================
-- ============================================================
