...
**Product:** Personal Life OS dashboard (metrics, money, calendar, focus, discipline, sports, gamification)
...
React 19 + Tailwind (`frontend/`) · Node `server/` · Supabase Postgres · Better Auth + Google OAuth · Vercel + API host (`api.aiimin.in`)
